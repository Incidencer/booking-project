        ...
        <div className="flex flex-col p-4 bg-blue-200 gap-4">
            ...
            <form onSubmit={isLoggedIn ? handleSubmit(onSubmit) : handleSubmit(onSignInClick)}>
                ...
                <label className="items-center flex">
                    ...
                    min={1}
                    max={20}
                    {...register("adultCount", {required: "This field is requred", min: {
                        value: 1,
            ...
            (<button className="bg-blue-600 text-white h-full p-2 font-bold hover:bg-blue-500 text-xl">Sign in to use this</button>)}
            </div>
            </form>
            </div>
    )
