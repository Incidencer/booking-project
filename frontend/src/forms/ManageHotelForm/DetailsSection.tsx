...
const DetailsSection = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            <h1 className="text-3xl font-bold mb-3 bg-gradient-to-r from-blue-600 via-cyan-900 to-blue-500 text-transparent inline-block bg-clip-text">Add Hotel</h1>
        ...
        <select
          ...
          className="border rounded w-full p-2 text-yellow-700 font-normal"
        >
